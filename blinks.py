...
# vs = Vid eoStream(usePiCamera=True).start()
# fileStream = False
time.sleep(1.0)
...
while True:
    ...
    for rect in rects:
        ...
        # otherwise, the eye aspect ratio is not below the blink threshold
            ...
            # draw the total number of blinks on the frame along
            # with the computed eye aspect ratio for the frame
